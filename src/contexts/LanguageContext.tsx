...
const translations: Record<Language, Record<string, string>> = {
  si: {
    ...
    'weddings.video1.duration': '2–6x kratki Content Video',
    'weddings.video1.description': 'Kratek, čustven povzetek dneva za social media.',
    'weddings.video1.features': '2–6 kratkih video povzetkov za Instagram / Reels|Dinamičen vertical format, optimiziran za social|Čustven, avtentičen občutek dneva v 15–30 sekundah|Dostava digitalno v 10 dneh',
    'weddings.video2.duration': 'Do 3 ure snemanja',
    'weddings.video2.description': 'Manjša poroka, velika čustva. Vse bistveno, nič odvečnega.',
    'weddings.video2.features': 'Do 3 ure snemanja (civilni obred / kratka slovesnost)|Highlight film 3–5 min|Barvna korekcija|Dostava digitalno',
    'weddings.video3.duration': 'Do 12 ur prisotnosti',
    'weddings.video3.description': 'Tvoj dan, posnet v celoti. Od jutra do zadnjega plesa.',
    'weddings.video3.features': 'Do 12 ur prisotnosti|1 snemalec|Highlight film (4–6 min) + daljši celodnevni film|Profesionalna barvna korekcija|Dostava digitalno v 3–4 tednih',
    'weddings.video4.duration': 'Do 13 ur prisotnosti',
    'weddings.video4.description': 'Filmska izkušnja za tiste, ki ne želijo kompromisov.',
    'weddings.video4.features': 'Do 13 ur prisotnosti|Snemanje v 4K s cinema opremo|Kreativni film 15–25 min + highlight film|Napredni color grading|Drone posnetek (+150 €)|Dostava digitalno + možnost USB',
  ...
  en: {
    ...
    'hero.description': 'Let your day be relaxed. You experience it, and we capture the story – from small details to big moments.',
    ...
    'weddings.video1.duration': '2–6x short Content Videos',
    'weddings.video1.description': 'A short, emotional summary of the day for social media.',
    'weddings.video1.features': '2–6 short video highlights for Instagram / Reels|Dynamic vertical format optimized for social|Emotional, authentic feel of the day in 15–30 seconds|Digital delivery within 10 days',
    'weddings.video2.duration': 'Up to 3 hours of filming',
    'weddings.video2.description': 'Smaller wedding, big emotions. Everything essential, nothing extra.',
    'weddings.video2.features': 'Up to 3 hours of filming (civil ceremony / short celebration)|Highlight film 3–5 min|Color correction|Digital delivery',
    'weddings.video3.duration': 'Up to 12 hours of presence',
    'weddings.video3.description': 'Your day, filmed in full. From morning to the last dance.',
    'weddings.video3.features': 'Up to 12 hours of presence|1 videographer|Highlight film (4–6 min) + longer full-day film|Professional color correction|Digital delivery in 3–4 weeks',
    'weddings.video4.duration': 'Up to 13 hours of presence',
    'weddings.video4.description': "A cinematic experience for those who don't want compromises.",
    'weddings.video4.features': 'Up to 13 hours of presence|Filming in 4K with cinema equipment|Creative film 15–25 min + highlight film|Advanced color grading|Drone shot (+150 €)|Digital delivery + optional USB',
  ...
  de: {
    ...
    'hero.description': 'Lassen Sie Ihren Tag entspannt sein. Sie erleben ihn, und wir fangen die Geschichte ein – von kleinen Details bis zu großen Momenten.',
    ...
    'weddings.video1.duration': '2–6x kurze Content Videos',
    'weddings.video1.description': 'Eine kurze, emotionale Zusammenfassung des Tages für Social Media.',
    'weddings.video1.features': '2–6 kurze Video-Highlights für Instagram / Reels|Dynamisches Vertikalformat, optimiert für Social Media|Emotionales, authentisches Tagesgefühl in 15–30 Sekunden|Digitale Lieferung innerhalb von 10 Tagen',
    'weddings.video2.duration': 'Bis zu 3 Stunden Aufnahme',
    'weddings.video2.description': 'Kleinere Hochzeit, große Emotionen. Alles Wesentliche, nichts Überflüssiges.',
    'weddings.video2.features': 'Bis zu 3 Stunden Aufnahme (standesamtliche Trauung / kurze Feier)|Highlight-Film 3–5 Min|Farbkorrektur|Digitale Lieferung',
    'weddings.video3.duration': 'Bis zu 12 Stunden Anwesenheit',
    'weddings.video3.description': 'Ihr Tag, komplett gefilmt. Vom Morgen bis zum letzten Tanz.',
    'weddings.video3.features': 'Bis zu 12 Stunden Anwesenheit|1 Videograf|Highlight-Film (4–6 Min) + längerer Ganztagsfilm|Professionelle Farbkorrektur|Digitale Lieferung in 3–4 Wochen',
    'weddings.video4.duration': 'Bis zu 13 Stunden Anwesenheit',
    'weddings.video4.description': 'Ein filmisches Erlebnis für alle, die keine Kompromisse eingehen wollen.',
    'weddings.video4.features': 'Bis zu 13 Stunden Anwesenheit|Aufnahme in 4K mit Cinema-Ausrüstung|Kreativfilm 15–25 Min + Highlight-Film|Erweitertes Color Grading|Drohnenaufnahme (+150 €)|Digitale Lieferung + USB optional',
  ...
  hr: {
    ...
    'hero.description': 'Neka vaš dan bude opušten. Vi ga doživite, a mi hvatamo priču – od sitnih detalja do velikih trenutaka.',
    ...
    'weddings.video1.duration': '2–6x kratki Content Video',
    'weddings.video1.description': 'Kratak, emotivan sažetak dana za društvene mreže.',
    'weddings.video1.features': '2–6 kratkih video sažetaka za Instagram / Reels|Dinamičan vertikalni format, optimiziran za društvene mreže|Emotivan, autentičan osjećaj dana u 15–30 sekundi|Digitalna dostava u 10 dana',
    'weddings.video2.duration': 'Do 3 sata snimanja',
    'weddings.video2.description': 'Manje vjenčanje, velike emocije. Sve bitno, ništa suvišno.',
    'weddings.video2.features': 'Do 3 sata snimanja (civilni obred / kraća svečanost)|Highlight film 3–5 min|Korekcija boja|Digitalna dostava',
    'weddings.video3.duration': 'Do 12 sati prisutnosti',
    'weddings.video3.description': 'Vaš dan, snimljen u cijelosti. Od jutra do posljednjeg plesa.',
    'weddings.video3.features': 'Do 12 sati prisutnosti|1 snimatelj|Highlight film (4–6 min) + duži cjelodnevni film|Profesionalna korekcija boja|Digitalna dostava u 3–4 tjedna',
    'weddings.video4.duration': 'Do 13 sati prisutnosti',
    'weddings.video4.description': 'Filmsko iskustvo za one koji ne žele kompromise.',
    'weddings.video4.features': 'Do 13 sati prisutnosti|Snimanje u 4K s kino opremom|Kreativni film 15–25 min + highlight film|Napredni color grading|Snimak dronom (+150 €)|Digitalna dostava + mogućnost USB-a',
